...
function Sidebar({
  ...
  const handleDrop = (
    ...
    const droppedGroup = eventGroups.find(
              ...
              <>
                ...
                <div className="group-actions">
                  <button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      toggleEventGroupVisibility(group.id);
                    }}
                    disabled={!!editingGroup}
                    className={`visibility-toggle ${
                      group.isVisible === false ? "hidden" : ""
                    }`}
                    aria-label={`${group.isVisible === false ? "Show" : "Hide"} ${group.name}`}
                    aria-pressed={group.isVisible !== false}
                  >
                    {group.isVisible === false ? (
                      <EyeCloseIcon color="var(--icon-color)" />
                    ) : (
                      <EyeIcon color="var(--icon-color)" />
                    )}
                  </button>
                  <button
                    onClick={(e) => {
